    ...
    public function list(Request $request)
{
    ...
    return DataTables::of($users)
        ...
        ->addColumn('aksi', function ($user) {
            $btn  = '<a href="' . url('/user/' . $user->user_id) . '" class="btn btn-info btn-sm">Detail</a> '; // Detail button
            $btn .= '<a href="' . url('/user/' . $user->user_id . '/edit') . '" class="btn btn-warning btn-sm">Edit</a> '; // Edit button
    ...
    public function destroy(string $id){
        ...
        try{
            ...
            return redirect('/user')->with('error', 'Data user gaga; dihapus karena masih terdapat tabel lain yang terkait dengan data ini');
        }
    }
}